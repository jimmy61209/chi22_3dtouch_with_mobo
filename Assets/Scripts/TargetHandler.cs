...
public class TargetHandler : MonoBehaviour
{
    ...
    void OnTriggerStay(Collider other)
    {
        ...
        if(leaveOrigin){
            ...
            if(dwellCount >= 0.5f && gameObject.transform.Find("mesh").GetComponent<MeshRenderer>().material.color == Color.yellow){
                ...
                OnFinishUnitTask(objectives, false);
    ...
    void trial_fail(){
        if(trialFailBool == true){
            ...
            trialFailBool = false;
            OnFinishUnitTask(objectives, true);
        }
        else{
            trialFailBool = true;
        }
    ...
    void OnFinishUnitTask(List<float> objectives, bool trialFail)
    {
        ...
        EM.OnFinishUnitTask(objectives, trialFail);
    }
}
